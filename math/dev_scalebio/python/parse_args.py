...
def parse_argument(sys_argv):
    ...
    parser.add_argument(
        '--clip_model', action='store_true',
        help='Clip the model parameters gradient')
    ...
    parser.add_argument(
        '--lisa_n_layers', type=int,
        default=2,
        help='number of layers for lisa'
    )
    parser.add_argument(
        '--model-type', type=str,
        default='llama',
    ...
    parser.add_argument(
        '--warmup_on_w_lambda_steps', type=int,
        default=0,
        help='warm up steps on w and lambda'
    )
    parser.add_argument(
    ...
    parser.add_argument(
        '--lambda_grad_clip_value', type=float, default=None,
        help='clip the gradient of lambda'
    )
    parser.add_argument(
        '--lambda_grad_clip_norm', type=float, default=None,
        help='clip the gradient of lambda'
    )
    parser.add_argument(
    ...
    parser.add_argument(
        '--A_weight', 
        help='A weight in importance sampling saved in json'
    )
    parser.add_argument(
